...
public class Tallers1 {
	...
	String RutaRegistros = "C:\\Users\\Usuario\\Downloads\\Registros.txt"; 

	//cambiar estos strings segun posicion del archivo

	String RutaUsuarios = "C:\\Users\\Usuario\\Downloads\\Usuarios.txt";
		...
		if (respuestados.equals("5")) {break;}
		...
		FileWriter escribir = new FileWriter(RutaRegistros);
		...
		Scanner scaregistros = new Scanner(new File(RutaRegistros));
